...
it("should successfully execute GET /people/~/group-memberships/:group-id (getMembershipDetails)",  function(next) {
    client.groups.getMembershipDetails(
        {
                "group-id": "String",
                "url-field-selector": "String"
            },
...
it("should successfully execute GET /posts/:post-id/comments (getPostComments)",  function(next) {
    client.groups.getPostComments(
        {
                "post-id": "String",
                "start": "Number",
                "count": "Number",
...
it("should successfully execute POST /post/:post-id/comments (addPostComment)",  function(next) {
    client.groups.addPostComment(
        {
                "post-id": "String",
                "data": "Json"
            },
...
it("should successfully execute DELETE /comments/:comment-id (removeComment)",  function(next) {
    client.groups.removeComment(
        {
                "comment-id": "String"
            },
        function(err, res) {
